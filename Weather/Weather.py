...
#today's weather. Update the parse file if we need to do it, after this parse by one day - today
    @staticmethod
    def todayweather():
        Weather.updateparse('zest.html', 'https://www.yandex.ru', 4)
...
# 'sho po pogode'- return weather by week, if we have integer - return weather by this day
    ...
    def weathebydayintheweek(value):
        mass = []
        Weather.updateparse('zest1.html', 'https://yandex.ru/pogoda/moscow', 4)
...
if __name__ == "__main__":
    ...
    #print Weather.weathebydayintheweek(u'что по погоде на неделю')
